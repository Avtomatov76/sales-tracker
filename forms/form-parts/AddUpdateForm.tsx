  ...
  return (
    <View style={{ width: "100%" }}>
      ...
      <TextInput
        ...
        value={
          props.formValues.firstName === "na" ? "" : props.formValues.firstName
        }
      ...
      <TextInput
        ...
        value={
          props.formValues.lastName === "na" ? "" : props.formValues.lastName
        }
      ...
      <TextInput
        ...
        value={
          props.formValues.address === "na" ? "" : props.formValues.address
        }
        placeholder="Address"
        placeholderTextColor="grey"
      ...
      <TextInput
        ...
        value={props.formValues.city === "na" ? "" : props.formValues.city}
        placeholder="City"
        placeholderTextColor="grey"
      ...
      <TextInput
        ...
        value={props.formValues.state === "na" ? "" : props.formValues.state}
      ...
      <TextInput
        ...
        value={props.formValues.phone === "na" ? "" : props.formValues.phone}
      ...
      <TextInput
        ...
        value={props.formValues.email === "na" ? "" : props.formValues.email}
      ...
      >
        <CustomButton submitForm={props.submitForm} flag="add" />
